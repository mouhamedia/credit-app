...
<div class="container mt-4">
    ...
    {{-- En-tête avec navigation et infos client --}}
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mt-2 mb-0 ms-5">
                ...
                <strong><i class="bi bi-key me-1"></i> Code :</strong> 
                <code class="bg-light border text-dark px-2 py-1 rounded">{{ $client->code_unique }}</code>
            </p>
        </div>
        {{-- Bouton d'action Samacahier (Vert) --}}
        <a href="{{ route('boutiquier.credits.create', $client->id) }}" class="btn btn-success btn-lg shadow-sm fw-bold">
    ...
    <div class="row mb-5">
        ...
        {{-- Carte Total Crédit en couleur d'accent (info) --}}
        <div class="col-md-4 mb-3">
                ...
                <table class="table table-striped table-hover align-middle mb-0">
                    ...
                    <tbody>
                        @foreach($client->credits()->latest()->get() as $credit)
                            {{-- Utilisation de bg-success uniquement sur la ligne pour un statut Payé --}}
    ...
    @else
        <div class="alert alert-info text-center p-5">
            <h4><i class="bi bi-info-circle-fill me-2"></i> Aucun crédit enregistré pour ce client</h4>
            <p class="fs-5">Commencez par ajouter un crédit en cliquant sur le bouton vert en haut à droite.</p>
        </div>
    @endif
