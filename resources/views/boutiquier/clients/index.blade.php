...
<div class="row">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <div>
                            <span class="text-danger small fw-bold">
                                <i class="bi bi-arrow-down-left-circle-fill me-1"></i> Impayé :
                            </span><br>
                            <span class="text-danger fw-bold fs-5">
                                {{ number_format($client->total_impaye, 0, ',', ' ') }} FCFA
                            </span>
                        </div>

                        <div>
                            <span class="text-success small fw-bold text-end">
                                <i class="bi bi-arrow-up-right-circle-fill me-1"></i> Payé :
                            </span><br>
                            <span class="text-success fw-bold fs-5 text-end">
                                {{ number_format($client->total_paye, 0, ',', ' ') }} FCFA
                            </span>
                        </div>
                    </div>

                    <div class="d-grid gap-2 mt-3">
                        <a href="{{ route('boutiquier.clients.credits', $client->id) }}" 
    ...
    @empty
        <div class="alert alert-info text-center p-5">
            <h4 class="mb-3">
                <i class="bi bi-info-circle-fill me-2"></i> Aucun client trouvé.
            </h4>
